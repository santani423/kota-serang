...
export default function ServicesHero() {
  ...
  return (
    <section
      className="pt-28 pb-16 bg-white dark:bg-[#0A1628] relative overflow-hidden"
          ...
          <div className="reveal">
            ...
            >
             ...
             <p className="text-lg text-gray-500 dark:text-slate-400 leading-relaxed mt-4">
              Akses 120+ layanan pemerintahan Kota Serang secara digital — kapan saja, di mana saja, tanpa antri.
            </p>
          </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="
                  ...
                  border border-serang-border dark:border-white/10
                  bg-serang-bg dark:bg-[#162032]
                  text-serang-foreground dark:text-white
                  placeholder-serang-muted dark:placeholder-slate-500
                  outline-none
              ...
              {search.trim() && (
                <button
                  ...
                  className="
                    ...
                    text-gray-300 hover:text-serang-foreground
        ...
        >
          {[
            ...
            <div key={label} className="flex items-center gap-2">
              <span className="text-xl font-display font-bold text-[#1E3A8A] dark:text-accent-light">
                {value}
              </span>
